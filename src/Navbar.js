        ...
        <Link className="navbar-brand" to="/">Home</Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className={`form-check form-switch text-${props.mode==='light' ? 'dark' : 'light'}`}>
              <input className="form-check-input" type="checkbox" onClick={()=>{props.toggleMode('null')}} role="switch" id="switch" />
              <label className="form-check-label" htmlFor="switch">Enable Mode</label>
            </div>
          </div>
        </div>
      </nav>
